    ...
    {hasInput && workspaceBuilt ? <>
      <WorkbenchPanel className="space-y-4">
        <div className="ba-output-section-head">
          <div><p className="ba-output-section-eyebrow" style={{ color: "var(--clr-accent)" }}>Research brief</p><h2 className="ba-output-section-title">Target context</h2></div>
      ...
      <WorkbenchPanel className="space-y-4">
        <div className="ba-output-section-head">
          <div><p className="ba-output-section-eyebrow" style={{ color: "var(--clr-accent)" }}>Backend helpers</p><h2 className="ba-output-section-title">Terminal-assisted OSINT</h2><p className="mt-1 text-sm leading-6 text-zinc-300">Optional local wrappers for DNS, mail posture, headers, TLS, WHOIS, and passive enum tools. Use only for authorized targets.</p></div>
