declare module "@/api/backend" {
  ...
  export const runReconNmapScan: (opts: { target: string; mode: string; confirmPermission: boolean; allowPrivate?: boolean }) => Promise<Record<string, unknown>>;
  ...
  export const runHackingtoolTool: (opts: { categoryId: string; toolId: string; target: string; args: string }) => Promise<Record<string, unknown>>;
